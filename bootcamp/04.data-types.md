...
> `C` includes built-in data types like `int`, `float`, `double`, `char`, and `void`.
> External types such as `bool` and `string` require libraries like **stdbool.h** and **string.h**.
<br>
### Format Specifier    
